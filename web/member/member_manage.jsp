        ...
        layui.use(['element','laydate','table'], function(){
            ...
            table.render({
                ...
                ,cols: [[
                    ...
                    ,{field:'Invitation_code1', width: 120, title: '邀请码',templet:'#Invitation_code',align:'center'}
                    ,{field:'member_level', width:120, title: '会员类型', templet:'#member_levelTpl',align:'center'}
                    ,{field:'status', width:100, title: '账号状态', templet:'#statusTpl',align:'center'}
                    ,{field:'e_mail', width:150, title: 'E-mail',templet:'#EmialTpl',align:'center'}
                    ,{field:'registration_time', width:165, title: '注册时间',templet: '#create_timeTpl',align:'center'}
                    ,{field:'source', width:100, title: '注册来源',templet:'#sourceTpl',align:'center'}
                    ,{field:'wealth', width:100, title: '操作',toolbar:"#barDemo",align:'center'}
                ]]
                ,limit:20
